...
INSERT INTO SERVICO_CONTRATADO (id_contrato, id_servico, custo_mensal)
VALUES (990,4, (SELECT custo_referencia_mensal 
                FROM servico s 
                WHERE s.id_servico = 4)
);
...
INSERT INTO SERVICO_CONTRATADO (id_contrato, id_servico, custo_mensal)
VALUES (990,0, (SELECT custo_referencia_mensal 
                FROM servico s 
                WHERE s.id_servico = 0)
);
...
INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (002, 998, 0, to_date('2019-10-03', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (003, 997, 0, to_date('2019-10-02', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (004, 996, 0, to_date('2019-10-04', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (005, 995, 0, to_date('2019-10-01', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (006, 994, 0, to_date('2019-10-05', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (007, 993, 0, to_date('2019-10-09', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (008, 992, 0, to_date('2019-10-07', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (009, 991, 0, to_date('2019-10-08', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);

INSERT INTO fatura (id_fatura, ID_CONTRATO, VALOR_TOTAL, DATA_EMISSAO, DATA_LIMITE_DE_PAGAMENTO, DATA_DO_PAGAMENTO, DESCRICAO_FATURA)
VALUES (010, 990, 0, to_date('2019-10-09', 'yyyy-mm-dd'), to_date('2019-10-30', 'yyyy-mm-dd'), null, null);
...
INSERT INTO DETALHE_FATURA (id_fatura, ID_LINHA_FATURA, ID_CONTRATO, ID_SERVICO, valor, OBSERVACOES)
VALUES (005, 002, 995, 7, (SELECT custo_referencia_mensal FROM servico s WHERE s.ID_SERVICO = 7), null);
...
INSERT INTO DETALHE_FATURA (id_fatura, ID_LINHA_FATURA, ID_CONTRATO, ID_SERVICO, valor, OBSERVACOES)
VALUES (010, 001, 990, 4, ((SELECT custo_referencia_mensal FROM servico s WHERE s.ID_SERVICO = 4)), null);

INSERT INTO DETALHE_FATURA (id_fatura, ID_LINHA_FATURA, ID_CONTRATO, ID_SERVICO, valor, OBSERVACOES)
VALUES (010, 002, 990, 5, ((SELECT custo_referencia_mensal FROM servico s WHERE s.ID_SERVICO = 5)), null);

INSERT INTO DETALHE_FATURA (id_fatura, ID_LINHA_FATURA, ID_CONTRATO, ID_SERVICO, valor, OBSERVACOES)
VALUES (010, 003, 990, 0, ((SELECT custo_referencia_mensal FROM servico s WHERE s.ID_SERVICO = 0))+1, null);
...
VALUES (990, 5, 9, to_date('09:45:00 2019-05-01', 'hh24:mi:ss yyyy-mm-dd'), to_date('10:45:00 2019-05-01', 'hh24:mi:ss yyyy-mm-dd'), 'Nada a observar');

INSERT INTO ASSISTENCIA_TECNICA (id_contrato, ID_SERVICO, ID_TECNICO, DATA_HORA_INICIO, DATA_HORA_FIM, OBSERVACOES)
VALUES (991, 0, 9, to_date('13:29:00 2019-05-01', 'hh24:mi:ss yyyy-mm-dd'), to_date('16:29:00 2019-05-01', 'hh24:mi:ss yyyy-mm-dd'), 'Nada a observar');

INSERT INTO ASSISTENCIA_TECNICA (id_contrato, ID_SERVICO, ID_TECNICO, DATA_HORA_INICIO, DATA_HORA_FIM, OBSERVACOES)
VALUES (992, 4, 9, to_date('13:10:00 2019-05-02', 'hh24:mi:ss yyyy-mm-dd'), to_date('18:10:00 2019-05-02', 'hh24:mi:ss yyyy-mm-dd'), 'Nada a observar');
...
FROM 
    servico s
FULL OUTER JOIN servico_contratado sc ON (s.id_servico=sc.id_servico) 
GROUP BY s.nome
...
SELECT DISTINCT sc.ID_SERVICO,
	   --f.id_fatura, 	   
	   (to_char(f.DATA_EMISSAO, 'DD-mon-YYYY')) AS "DATA DE FATURACAO",
	   f.id_contrato 
FROM 
	fatura f
INNER JOIN 
